...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    //~ Create points -
    points.push([loc.coordinates[1], loc.coordinates[0]]); //~ Load all markers and popups as soon as map gets loaded -
    ...
    map.on('load', function () {
      ...
      .bindPopup("<h2 style=\"color:#777\"> <span style=\"color:#55c57a\"> Day ".concat(loc.day, " :</span> ").concat(loc.description, "</h2>"), {
        className: 'mapPopup',
        autoClose: false,
        offset: L.point(0, 35),
        closeOnClick: false
...
var showAlert = function showAlert(type, msg) {
  ...
  window.setTimeout(hideAlert, 2000); //afterbegin - inside body 1st element.
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            link = type === 'password' ? 'updateMyPassword' : 'updateMe';
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:3000/api/v1/users/".concat(link),
              data: data
            });

          case 4:
            res = _context.sent;
            if (res.data.status === 'success') (0, _alerts.showAlert)('success', "".concat(type[0].toUpperCase() + type.slice(1), " updated successfully!"));
            _context.next = 11;
            break;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51LrGZ2SGKy166rvY8EvwugOT1kTPrVt5VnrXJg7WT5BCRrmrhkCMs7TRoQX973dVPsXBN1G67W14fvFDzxfI329o00vPR7ocGo');
            _context.prev = 1;
            _context.next = 4;
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault(); //For uploading images we cant do like this. so we need a FormData constructor which actually returns an object containing all user inputed data.
  ...
  form.append('photo', document.getElementById('photo').files[0]); // It is an array of multiple files. document.getElementById('photo').files[0]
